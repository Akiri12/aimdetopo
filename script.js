...
function spawnRandom(){
  if(state.mode==='free'){
    if(state.freeNextCenter){
      ...
      let x, y, attempts = 0;
      const minDist = 19; // distancia mínima respecto a la última burbuja
      do {
        ...
        attempts++;
        // evitar spawn demasiado cercano
  ...
  function drawBubble(b, now){
    ...
    if(b.label){
      ...
      if(!b.armed){
        ...
        //ctx.textBaseline='alphabetic'; ctx.fillText('Clic aquí',b.x,b.y+r+16*DPR);
      }
    }
  }
